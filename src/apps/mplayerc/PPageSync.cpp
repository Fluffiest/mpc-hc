...
BOOL CPPageSync::OnInitDialog()
{
	...
	if ((s.iDSVideoRendererType == VIDRNDT_DS_EVR_CUSTOM || s.iDSVideoRendererType == VIDRNDT_DS_VMR9RENDERLESS) && (pFrame->m_iPlaybackMode == PM_NONE))
	{
	...
	if (s.iDSVideoRendererType == VIDRNDT_DS_EVR_CUSTOM)
